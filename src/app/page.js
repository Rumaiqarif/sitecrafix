...
import { FaInstagram, FaLinkedin, FaWhatsapp } from "react-icons/fa"; // ✅ Add FaWhatsapp
...
<section className={styles.brandingSection} id="branding">
  ...
  {/* Horizontal scroll for cards (mobile), grid for desktop */}
...
<section className={styles.portfolio} id="portfolio">
  ...
  <div className={styles.portfolioScroll}>
    <div className={styles.portfolioGrid}>
      ...
      <div className={styles.portfolioItem}>
        <img src="/images/portfolio.jpg" alt="DigitalKraft project" />
        <h3>DigitalKraft</h3>
      ...
      <div className={styles.portfolioItem}>
        <img src="/images/servezlogo2.png" alt="ServeEZ project" />
        <h3>ServeEZ</h3>
            ...
            <div className={styles.testimonialWrapper}>
              <div className={styles.testimonialCard}>
                ...
                <div className={styles.client}>
                  <img src="/images/ayesha.webp" alt="Ayesha K." />
                  <span>Ayesha K.</span>
                </div>
              </div>
              <div className={styles.testimonialCard}>
                ...
                <div className={styles.client}>
                  <img src="/images/raj.jpg" alt="Raj P." />
                  <span>Raj P.</span>
                </div>
              </div>
              <div className={styles.testimonialCard}>
                ...
                <div className={styles.client}>
                  <img src="/images/zubair.webp" alt="Zubair Hamza" />
              ...
              <div className={styles.testimonialCard}>
                ...
                <div className={styles.client}>
                  <img src="/images/rafiq.webp" alt="Rafiq Ahmad" />
...
<section className={styles.socials} id="socials">
  ...
  <div className={styles.icons}>
    ...
    <a href="https://wa.me/91914962459" target="_blank" rel="noopener noreferrer"> {/* ✅ Replace with your number */}
      <FaWhatsapp />
      <span>WhatsApp</span>
    </a>
  </div>
  ...
  action="https://formspree.io/f/myzwojoa" // ← your actual form URL
  method="POST"
>
